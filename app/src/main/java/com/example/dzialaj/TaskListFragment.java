...
public class TaskListFragment extends Fragment {
    ...
    private class TaskHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public TaskHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            iconImageView = itemView.findViewById(R.id.obrazek);
            checkBox = itemView.findViewById(R.id.czekBoxLista);
        }
        public void bind(Task task) {
            ...
            if(task.getCategory().equals(Category.DOM)){
                ...
                iconImageView.setImageResource(R.drawable.ic_studia);
            }
    ...
    public void updateSubtitle(){
        ...
        List<Task> tasks = taskStorage.getListaZadan();
